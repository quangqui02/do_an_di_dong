...
class TransactionVinaphone extends StatefulWidget {
  const TransactionVinaphone({super.key});

  @override
  State<TransactionVinaphone> createState() => _TransactionViettelState();
}

class _TransactionViettelState extends State<TransactionVinaphone> {
  @override
